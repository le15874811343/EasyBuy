...
public class EasyBuyProductDaoImpl extends BaseDao implements IEasyBuyProductDao {
	...
	public Map<Long, EasyBuyProduct> listByChildId(Double epRebate,Long epcId,Long epcChildId,int targetPage, int pageSize) {
		...
		return super.getSqlSessionTemplate().selectMap("easybuy.pojo.mapping.EasyBuyProductMapper.listByChildId", params,"epId");
	}
	...
	public int upDate(EasyBuyProduct easyBuyProduct) {
		return super.getSqlSessionTemplate().update("easybuy.pojo.mapping.EasyBuyProductMapper.stock",easyBuyProduct);
	}
